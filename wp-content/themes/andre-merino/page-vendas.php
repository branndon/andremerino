...
<section class="atendimento">
	...
	<div class="palco colunas-09">
		<article>
			<?php
				echo '<h1><strong>atendimento</strong></h1>';
			?>
		...
		<section id="contato" class="sidebar_interna palco colunas-12">
			...
			<div class="grid colunas-12">
				<div class="content_phone">
					...
					<a href="http://www.vainacaixa.com.br/" target="_blank">
						<img src="<?php bloginfo( 'template_directory' ); ?>/images/vendas_banner_varejo.jpg">
					</a>
